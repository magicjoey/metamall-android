...
import com.metamall.activity.DeliveryedActivity;
import com.metamall.activity.DrawbackActivity;
import com.metamall.activity.ForDeliveryActivity;
import com.metamall.activity.LogisticsActivity;
...
public class DeliveryedAdapter extends UniversalAdapter<ProductData> {





    public DeliveryedAdapter(Context context, List<ProductData> datas,
                              int itemLayoutId) {
    ...
    public void updateItem(final ViewHolder holder, final ProductData data) {
        ...
        NetworkImageView iv = holder.getView(R.id.item_deliveryed_iv);
        NetworkManager.getInstance().setImageUrl(iv, data.getImgUrl());
        holder.setTextViewText(R.id.item_deliveryed_tv_info, data.getInfo());
        holder.setTextViewText(R.id.item_deliveryed_tv_price, "￥" + data.getPrice());

        Button btnDrawback = holder.getView(R.id.item_deliveryed_view_logistics);
        btnDrawback.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent();
                i.setClass(DeliveryedActivity.deliveryedActivity, LogisticsActivity.class);
                DeliveryedActivity.deliveryedActivity.startActivity(i);
                DeliveryedActivity.deliveryedActivity.finish();
            }
        });
        Button btnPress = holder.getView(R.id.item_deliveryed_btn_press);
