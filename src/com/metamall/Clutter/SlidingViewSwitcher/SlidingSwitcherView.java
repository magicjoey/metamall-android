 ...
 *
 * @author Bells
 * @version SlidingSwitcherView.java 1.0 Created@2015-12-20 16:38 $
 */
public class SlidingSwitcherView extends RelativeLayout implements View.OnTouchListener {
    ...
    private void initializeItems() {
        ...
        itemsLayout = (LinearLayout) getChildAt(0);       //菜单布局，获取Linearlayout的子标签
        itemsCount = itemsLayout.getChildCount();         //返回包含的item总数量
    ...
    private void refreshDotsLayout() {
        ...
        for (int i = 0; i < itemsCount; i++) {
            ...
            if (i == currentItemIndex) {
                ...
                image.setBackgroundResource(R.drawable.unselected_dot);
            }
