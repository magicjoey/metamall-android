...
public class MyAllOrderActivity extends Activity {
    ...
    private void initView() {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(MyAllOrderActivity.this,LoginActivity.class);
    ...
    private void getCartProducts() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            data.setId(i);
            data.setImgUrl("http://i.ce.cn/ce/xwzx/gnsz/gdxw/201502/07/W020150207284918744995.jpg");
            data.setInfo("这才是女神这才是女神这才是女神这才是女神");
            data.setPrice(120);
            list.add(data);
        }
        products.clear();
