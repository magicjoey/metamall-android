...
public class CompletedActivity extends CartActivity {
    ...
    private void initView() {
        btnEdit = (Button) findViewById(R.id.completed_setting);
        ...
        suggestLayout = (RelativeLayout) findViewById(R.id.completed_suggest_layout);
        btnLogin = (Button) findViewById(R.id.completed_btn_login);
        btnLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(CompletedActivity.this,LoginActivity.class);
                startActivity(intent);
                CompletedActivity.this.finish();
                overridePendingTransition(R.anim.in_from_right, R.anim.out_to_left);
            }
        });
        tvEmpty = (TextView) findViewById(R.id.completed_tv_empty);
        listLayout = (LinearLayout) findViewById(R.id.completed_list_layout);
        listView = (ListView) findViewById(R.id.completed_lv);
        listView.setAdapter(adapter);
        checkLayout = (RelativeLayout) findViewById(R.id.completed_check_layout);
        cbCheckAll = (CheckBox) findViewById(R.id.completed_cb_all);
        ...
        tvTotal = (TextView) findViewById(R.id.completed_tv_total);
        btnBuy = (Button) findViewById(R.id.completed_btn_buy);
