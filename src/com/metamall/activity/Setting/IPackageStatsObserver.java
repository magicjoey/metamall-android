...
public interface IPackageStatsObserver extends android.os.IInterface
{
    ...
    public static abstract class Stub extends android.os.Binder implements com.metamall.activity.Setting.IPackageStatsObserver
    {
         ...
         */
        public static com.metamall.activity.Setting.IPackageStatsObserver asInterface(android.os.IBinder obj)
        {
            if ((obj==null)) {
                return null;
            }
            android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
            if (((iin!=null)&&(iin instanceof com.metamall.activity.Setting.IPackageStatsObserver))) {
                return ((com.metamall.activity.Setting.IPackageStatsObserver)iin);
            }
            return new com.metamall.activity.Setting.IPackageStatsObserver.Stub.Proxy(obj);
        }
        ...
        private static class Proxy implements com.metamall.activity.Setting.IPackageStatsObserver
        {
