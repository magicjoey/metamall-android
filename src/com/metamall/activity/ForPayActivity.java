...
public class ForPayActivity extends CartActivity {
    ...
    private void initView() {
        ibback=(ImageButton) findViewById(R.id.ib_back_for_pay);
        ...
        btnEdit = (Button) findViewById(R.id.for_pay_setting);
        ...
        suggestLayout = (RelativeLayout) findViewById(R.id.for_pay_suggest_layout);
        btnLogin = (Button) findViewById(R.id.for_pay_btn_login);
        btnLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ForPayActivity.this,LoginActivity.class);
                startActivity(intent);
                ForPayActivity.this.finish();
                overridePendingTransition(R.anim.in_from_right, R.anim.out_to_left);
            }
        });
        tvEmpty = (TextView) findViewById(R.id.for_pay_tv_empty);
        listLayout = (LinearLayout) findViewById(R.id.for_pay_list_layout);
        listView = (ListView) findViewById(R.id.for_pay_lv);
        listView.setAdapter(adapter);
        checkLayout = (RelativeLayout) findViewById(R.id.for_pay_check_layout);
        cbCheckAll = (CheckBox) findViewById(R.id.for_pay_cb_all);
        ...
        tvTotal = (TextView) findViewById(R.id.for_pay_tv_total);
        btnBuy = (Button) findViewById(R.id.for_pay_btn_buy);
        btnBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (btnBuy.getText().toString()
                    ...
                    Intent i=new Intent();
                    i.setClass(ForPayActivity.this,PayConfirmActivity.class);
                    finish();
                    overridePendingTransition(R.anim.in_from_right, R.anim.out_to_left);
                } else {
