...
public class DeliveryedActivity extends CartActivity {
    ...
    private void initView() {
        ...
        btnEdit = (Button) findViewById(R.id.deliveryed_setting);
        ...
        checkLayout = (RelativeLayout) findViewById(R.id.deliveryed_check_layout);
        cbCheckAll = (CheckBox) findViewById(R.id.deliveryed_cb_all);
        ...
        tvTotal = (TextView) findViewById(R.id.deliveryed_tv_total);
        btnBuy = (Button) findViewById(R.id.deliveryed_btn_buy);
